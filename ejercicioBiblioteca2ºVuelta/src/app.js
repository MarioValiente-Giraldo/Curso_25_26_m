import { gestionMusica } from '../public/gestionMusica.js';
/**
 * 
 */
export function initApp() {
    ...
    // Inicializar gestor de playlists
    ...
    const indice = contruirIndiceBusqueda();
    ...
    recomendaciones.forEach((rec, index) => {
        console.log(`${index + 1}. ${rec.titulo} - ${rec.artista}`);
